...
// ============================================
// SET YOUR RETAIL PRICES HERE
// One price per product type (productUid)
// Add a new line when you add a new product type
// ============================================
const PRODUCT_TYPE_PRICES: Record<string, number> = {
  'flat_a0_170-gsm-65lb-coated-silk_4-0_ver': 36.57,  // A0 Classic Semi-Glossy Poster
  // 'mug_11oz_white': 24.99,                          // 11oz Mug (uncomment when adding mugs)
  // 'unisex-tshirt-001': 34.99,                       // Unisex T-Shirt (uncomment when adding shirts)
}

// ============================================
// ADD YOUR PRODUCTS HERE
// Just add a new line for each new poster/product
// templateId = copy from Gelato 3-dot menu
// ============================================
...
export default async function handler(req: any, res: any) {
  ...
  try {
    const products = GELATO_PRODUCTS.map((product) => {
      const image = `/product-images/${product.templateId}.jpeg`
      const price = PRODUCT_TYPE_PRICES[product.productUid] || 30
